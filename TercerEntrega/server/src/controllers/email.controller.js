...
const mailOptions = {
    from: "Coder Shop - " + config.gmailAccount,
    to: config.gmailAccount, // mi cuenta solo para testear. esto deberia ser dinamico
    subject: 'Su compra se ha realizado con éxito', // deberia ser dinamico
...
//     subject: 'Su compra se ha realizado con éxito',
//     html: ` <div>
...
//todo SE PUEDE APLICAR PARA MANDAR COMPROBANTE (TICKET) AL USUARIO DESPUES DE UNA COMPRA.